      ...
      <div className="pt-36 container1">
        <div className="grid justify-between grid-cols-1 sm:grid-cols-3 gap-3 ">
          <div className="w-26 h-[19rem] box">
            ...
            <div className="content">
              ...
              <p className="text-sm font-offer sm:font-offer">
                We know how frustrating it could be without knowing where to
                turn to with the questions you may have. We are here for you at
          ...
          <div className="w-26 h-[19rem] box">
            ...
            <div className="content">
              <h3>HOME SEARCH</h3>
              <p className="text-sm font-offer sm:font-offer">
                It&apos;s easier than ever to find your ideal home in Central
                Ohio. Define your criteria to see what&apos;s available on the
                market today.
              </p>
            </div>
          </div>
          ...
          <div className="w-26 h-[19rem] box">
            ...
            <div className="content">
              ...
              <p className="text-sm font-offer sm:font-offer">
                ...
                market. That is why we’ll send a cleaner to have your house
                ready for pictures and showings.
              </p>
            </div>
          </div>
          <div className="w-26 h-[19rem] box">
            ...
            <div className="content">
              ...
              <p className="text-sm font-offer sm:font-offer">
                Our team tailors a custom strategy for your home to reach a
                target audience with the most exposure. Things like Professional
                Photos, Custom Postcards, and Network Exposure. These results in
                you getting top dollar for your home.
              </p>
            </div>
          </div>
        </div>
        {/* <div className="pt-10 pb-20">
          <p className="pb-4 text-center font-normal text-2xl">
            Ask us about any of these services when <br /> Buying or Selling
            your Home!
          </p>
